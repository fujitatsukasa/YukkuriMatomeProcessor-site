...
import { ArrowRight, BadgeCheck, ClipboardCheck, Download, ExternalLink, FileText, MonitorPlay, Sparkles } from 'lucide-react'
            ...
            {videoSampleItems.map((item) => (
              <InteractiveCard key={item.title} className="sample-video-card premium-glass">
                ...
                <div className="sample-video-card__body">
                  ...
                  <a className="sample-video-card__fallback" href={item.video} target="_blank" rel="noopener noreferrer">
                    動画を別タブで開く
